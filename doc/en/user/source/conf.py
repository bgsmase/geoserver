...
# sphinx-quickstart on Fri Nov  8 15:32:36 2013.
#
...
html_static_path = ['../../themes/_static']
...
man_pages = [
    ('index', 'geoserver', u'GeoServer Documentation',
     [u'OpenPlans'], 1)
]
...
texinfo_documents = [
  ('index', 'GeoServer', u'GeoServer Documentation',
   u'OpenPlans', 'GeoServer', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [
    ('index', u'GeoSciMLWFSCookbook', u'GeoSciML WFS Cookbook', u'Marcus Sen'),
]
